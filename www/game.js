...
const theoryData = {
  count_basics: {
    hook: {
      question:  'Как думаешь, между цифрой и числом есть разница?',
      answers:   ['Конечно есть!', 'Это одно и то же'],
      reactions: ['Абсолютно верно! 🎯\nСейчас разберёмся подробнее', 'Сейчас удивим тебя! 💡\nТут есть интересный секрет'],
    },
  ...
  add10: {
    hook: {
      question:  'Сложение — это просто считать на пальцах?',
      answers:   ['Ну да, примерно', 'Думаю, есть способы лучше'],
      reactions: ['Пальцы — хороший старт! ✋\nНо есть и покруче — сейчас покажем', 'Правильно мыслишь! ⚡\nСейчас покажем кое-что интересное'],
    },
  ...
  add100: {
    hook: {
      question:  'При сложении двузначных начинаем с единиц, потом десятки?',
      answers:   ['Да, так правильно', 'Нет, всё равно с чего'],
      reactions: ['Правильно мыслишь! ⚡\nИменно так и делается', 'Есть хитрость! 💡\nПорядок очень важен — сейчас объясним'],
    },
  ...
  sub100: {
    hook: {
      question:  'Вычитание — это обратное сложение?',
      answers:   ['Да, точно!', 'Думаю, нет'],
      reactions: ['Абсолютно верно! 🎯\nОни связаны навсегда', 'А вот и связаны! 💡\nСейчас докажем'],
    },
  ...
  add1000: {
    hook: {
      question:  'Сложение трёхзначных работает так же, как двузначных?',
      answers:   ['Думаю, да', 'Там другие правила'],
      reactions: ['Именно! 🚀\nТот же принцип, просто больше разрядов', 'Нет, всё то же самое! 💡\nСейчас убедишься'],
    },
  ...
  sub1000: {
    hook: {
      question:  'Умеешь уже вычитать двузначные числа?',
      answers:   ['Да, умею!', 'Только учусь'],
      reactions: ['Отлично! 💪\nТрёхзначные — то же самое, не страшно', 'Не страшно! 📚\nРазберёмся вместе — шаг за шагом'],
    },
  ...
  multiply2_5: {
    hook: {
      question:  'Умножение — это быстрое сложение одинаковых чисел?',
      answers:   ['Именно так!', 'Думаю, нет'],
      reactions: ['Верно! ⚡\n5 × 3 = 5+5+5, только быстрее', 'Именно так! 🌟\nСейчас убедишься сам'],
    },
  ...
  multiply6_9: {
    hook: {
      question:  'Думаешь, 7 × 8 намного сложнее чем 3 × 4?',
      answers:   ['Да, намного сложнее', 'Нет, одинаково'],
      reactions: ['Согласны! 😏\nНо есть секрет — сейчас покажем', 'Почти! Пара комбо чуть хитрее ⚡\nСейчас разберём их'],
    },
  ...
  divide_easy: {
    hook: {
      question:  'Знаешь таблицу умножения на 2, 3, 4, 5?',
      answers:   ['Да, знаю!', 'Частично'],
      reactions: ['Отлично! 😎\nТогда деление — элементарно', 'Повторим вместе! 💪\nЭто проще чем кажется'],
    },
  ...
  divide_hard: {
    hook: {
      question:  'Деление на 6–9 намного сложнее чем на 2–5?',
      answers:   ['Да, сложнее', 'Нет, то же самое'],
      reactions: ['Согласны! Но есть секрет 🔑\nТаблица умножения спасёт', 'Правильно думаешь! 🎯\nПринцип одинаков, но есть пара хитрых чисел'],
    },
  ...
  compare: {
    hook: {
      question:  '482 больше 478 — как думаешь?',
      answers:   ['Да, больше', 'Хм, не уверен'],
      reactions: ['Верно! 🎯\nСейчас объясним как понять это быстро', 'Давай разберёмся! 🔢\nЕсть простой способ'],
    },
  ...
  ordinal: {
    hook: {
      question:  'Числа идут строго по порядку, без пропусков?',
      answers:   ['Конечно!', 'Бывают исключения?'],
      reactions: ['Именно! 📏\nСейчас потренируем находить пропуски', 'Нет, строго по порядку! 🎯\nКаждое следующее = предыдущее + 1'],
    },
  ...
  even_odd: {
    hook: {
      question:  'Любое число можно разделить на 2 без остатка?',
      answers:   ['Нет, не любое!', 'Думаю, любое'],
      reactions: ['Верно! 🎯\nТы уже знаешь о чётных и нечётных', 'Нет! И в этом весь секрет 🔢\nСейчас разберёмся'],
    },
  ...
  round: {
    hook: {
      question:  'Округление — это всегда в большую сторону?',
      answers:   ['Нет, зависит от цифры!', 'Конечно в большую'],
      reactions: ['Верно! 🎯\nВсё решает одна единственная цифра', 'Не всегда! ⭕\nЕсть чёткое правило — сейчас покажем'],
    },
  ...
  perimeter: {
    hook: {
      question:  'Периметр — это сумма всех сторон фигуры?',
      answers:   ['Да!', 'Нет, это площадь'],
      reactions: ['Точно! 🌿\nКак забор вокруг огорода — обходишь и считаешь', 'Площадь — другое! 📐\nСейчас расставим всё по местам'],
    },
  ...
  area: {
    hook: {
      question:  'Площадь и периметр — это разные вещи?',
      answers:   ['Конечно разные!', 'Думаю, одно и то же'],
      reactions: ['Именно! 📐\nСейчас разберём что есть что', 'Нет, это разные понятия! 🔲\nСейчас всё прояснится'],
    },
  ...
  fraction_half: {
    hook: {
      question:  '½ от 10 — это 5?',
      answers:   ['Да, конечно!', 'Не уверен'],
      reactions: ['Верно! 🍕\nТы уже знаешь дроби', 'Да, именно 5! 💡\nСейчас объясним почему'],
    },
  ...
  time: {
    hook: {
      question:  'В одном часе 60 минут — ты уверен?',
      answers:   ['Да, точно!', 'Хм, не уверен'],
      reactions: ['Верно! 🕐\nТы знаешь время — двигаемся дальше', 'Да, именно 60! ⏰\nЗапомним вместе — это важно'],
    },
  ...
  money: {
    hook: {
      question:  'Сдача — это разница между суммой и ценой покупки?',
      answers:   ['Да, точно!', 'Не уверен'],
      reactions: ['Правильно! 💰\nТы думаешь как опытный покупатель', 'Именно так! 🛒\nСейчас разберём на примерах'],
    },
  ...
  word_add: {
    hook: {
      question:  'Слово «всего» в задаче — это подсказка к сложению?',
      answers:   ['Да!', 'Не уверен'],
      reactions: ['Именно! 🧠\nТы уже думаешь как математик', 'Да, и это очень полезно знать! 📝\nСейчас покажем все слова-подсказки'],
    },
  ...
  word_mul: {
    hook: {
      question:  'Слово «по» в задаче намекает на умножение?',
      answers:   ['Да!', 'Думаю, нет'],
      reactions: ['Верно! ✖️\nПо 5 конфет каждому — это 5 × количество детей', 'Да, и это полезный лайфхак! 📝\nСейчас научим читать задачи на умножение'],
    },
  ...
  big_numbers: {
    hook: {
      question:  'Миллион — это тысяча тысяч?',
      answers:   ['Да!', 'Нет, это больше'],
      reactions: ['Точно! 🔭\n1 000 × 1 000 = 1 000 000', 'Нет, именно тысяча тысяч! 📊\nСейчас разберём большие числа'],
    },
  ...
  div_remainder: {
    hook: {
      question:  'При делении всегда получается целое число?',
      answers:   ['Нет, бывает остаток!', 'Да, всегда целое'],
      reactions: ['Верно! 🎯\n17 ÷ 5 = 3 и ещё 2 лишних конфеты', 'Не всегда! ➗\nСейчас покажем кое-что интересное'],
    },
  ...
  order_ops: {
    hook: {
      question:  'В примере 2 + 3 × 4 — сначала умножение?',
      answers:   ['Да, умножение первым!', 'Нет, слева направо'],
      reactions: ['Абсолютно верно! 💪\nУмножение «сильнее» сложения', 'Нет! Умножение — вне очереди 🔢\nСейчас объясним почему'],
    },
  ...
  equation_simple: {
    hook: {
      question:  'X в уравнении — это неизвестное число?',
      answers:   ['Да!', 'Нет, просто буква'],
      reactions: ['Верно! 🔍\nИ мы его обязательно найдём', 'X — это загадка! 🔣\nИ математика её разгадывает'],
    },
  ...
  speed: {
    hook: {
      question:  'Расстояние = скорость × время?',
      answers:   ['Да, так!', 'Не уверен'],
      reactions: ['Правильно! 🚀\nТы уже думаешь как физик', 'Именно так! ⚡\nСейчас объясним эту формулу на примере'],
    },
...
function showTheory(topic) {
  ...
  const hookEl    = document.getElementById('theoryHook');
  const flashEl   = document.getElementById('theoryFlash');
  ...
  if (data?.hook) {
    document.getElementById('theoryHookIcon').textContent     = topic.icon;
    document.getElementById('theoryHookTitle').textContent    = topic.name;
    document.getElementById('theoryHookQuestion').textContent = data.hook.question;

    const optsEl = document.getElementById('theoryHookOptions');
    optsEl.innerHTML = '';
    data.hook.answers.forEach((ans, i) => {
      const btn = document.createElement('button');
      btn.className   = 'hook-btn';
      btn.textContent = ans;
      btn.addEventListener('click', () => handleHookAnswer(data.hook.reactions[i], data, topic));
      optsEl.appendChild(btn);
    });
  } else {
    hookEl.style.display = 'none';
    showTheoryContent(data, topic);
    return;
  }
...
function handleHookAnswer(reaction, data, topic) {
  const hookEl  = document.getElementById('theoryHook');
  const flashEl = document.getElementById('theoryFlash');

  hookEl.style.display = 'none';
  document.getElementById('theoryFlashText').textContent = reaction;
  ...
  const proceed = () => {
    ...
    flashEl.removeEventListener('click', proceed);
    flashEl.classList.remove('active');
    setTimeout(() => showTheoryContent(data, topic), 350);
  };

  flashEl.addEventListener('click', proceed, { once: true });
